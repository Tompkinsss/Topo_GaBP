    ...
    void PushData(bool /* consume */) final {
        ...
        if (filelist_.contains_compressed) {
            ...
            while (it.HasNext()) {
                ...
                //size_t rank = this->context_.my_rank();
                //std::cout << "rank:" << rank << " " << tmp << std::endl;
                this->PushItem(tmp);
            }
        }
    }
...
private:
    ...
    public:
        ...
        InputLineIteratorUncompressed(const vfs::FileList& files,
            ...
            //size_t rank = node_.context_.my_rank();
            //std::cout << "rank:" << rank << " range:" << my_range_.begin << "-" << my_range_.end << std::endl;
